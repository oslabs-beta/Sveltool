// console.log('Running Sveltool content script');

// let editorExtensionId = chrome.runtime.id;

// const code = (function () {
//   //'use strict';
//   console.log('begining of content script function "Code"');
//   console.log('chrome.runtime.id --> ',editorExtensionId )
//   const components = [];
...
//         return (isFirstAfterUpdate = false);
//       }
